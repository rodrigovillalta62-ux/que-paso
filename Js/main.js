...
let para = "Dome"; // valor por defecto
let mensaje = `Oyeeee _-_ ...   me cuesta aceptar 
mis imprudencias, pero me pesa el pensar que 
quizas por mis acciones estés enojada
conmigo, solo queria disculparme por todo
y pedirte que ya me desbloquees 
por favor ? 🥹`;
...
let loadingText = "Para disculparme"; // valor por defecto para loading
